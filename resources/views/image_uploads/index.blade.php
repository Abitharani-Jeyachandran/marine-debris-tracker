                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 25%">
                                                ...
                                                <button  onclick="deleteConfirmation()" class="btn btn-sm btn-danger mr-1"><i class="fas fa-trash"></i> Delete</button>
                                                <form action="{{route('test.destroy',$value->id())}}" method="post" id='form-data'>
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
